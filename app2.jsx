...
function withDoi(text, key) {
  ...
  return [text.slice(0, i),
          React.createElement(Link, { href: "https://doi.org/" + m[1], key: "d" + key }, m[1]),
          text.slice(i + m[1].length)];
}
        ...
        <>
          ...
          {Object.entries(REFS).map(([k, r]) => (
            <div key={k} style={{ background: P.surface, borderRadius: 12, padding: "12px 14px", marginBottom: 8 }}>
              ...
              <p style={{ fontFamily: UI, fontSize: 13.5, lineHeight: 1.5, color: P.ink, margin: 0 }}>{r.full}</p>
...
/* ---- scopes ---------------------------------------------------------------
   ...
   shows 23 at once, so it needs a map. Kept SEPARATE and additive: nothing here
